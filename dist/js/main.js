  ...
  if (document.querySelector('.our-projects-slider')) {
    ...
    jquery_default().ajax({
      ...
      success: function (data) {
        ...
        jquery_default()('body').append(svgElement); 
      },
      error: function () {
    ...
    jquery_default()('#footer-form').on('submit', function (e) {
      e.preventDefault(); 
    ...
    let header = jquery_default()("#sticky-header"); 
    ...
    jquery_default()(window).on("scroll", function () {
        if (jquery_default()(this).scrollTop() > 0) {
            header.addClass("active"); 
        } else {
    ...
    function checkVisibility() {
      jquery_default()(".animate").each(function () {
        if (isElementInViewport(this) && !jquery_default()(this).hasClass("animated")) {
          jquery_default()(this).addClass("in-view animated");
        }
      });
    }
    ...
    jquery_default()(window).on("scroll resize", optimizedCheckVisibility);
    checkVisibility();
    ...
    jquery_default()('.accordion-item__title').on('click', function() {
      const content = jquery_default()(this).next('.accordion-item__content');

      jquery_default()('.accordion-item__content').not(content).slideUp().removeClass('active');
